...
<p><strong>Cybersecurity Student · Security Engineering · Cloud Security · Security Analysis</strong><br/>
Ukrainian · Building secure infrastructure at scale · Open-source security tools</p>

<p>
  <a href="https://www.linkedin.com/in/nazariy-buryak-778433350/" target="_blank">
  ...
  &nbsp;
  <a href="https://tryhackme.com/p/K0NGR3SS" target="_blank">
    <img title="TryHackMe" src="https://assets.tryhackme.com/img/favicon.png" height="28" width="28"/>
  </a>
</p>
...
<details open>
<summary>☁️ &nbsp;<strong>Cloud Security</strong></summary>
<br/>
...
<p>
  ...
  <img title="HCL / Terraform" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/terraform/terraform-original.svg" width="40" height="40"/>
</p>
...
<details>
<summary>🛡️ &nbsp;<strong>Security Engineering</strong></summary>
<br/>
...
<details>
<summary>🔍 &nbsp;<strong>SOC Analysis</strong></summary>
<br/>
...
<details>
<summary>⚙️ &nbsp;<strong>DevSecOps & Automation</strong></summary>
<br/>
...
|---|---|---|
| [WAFPierce](https://github.com/K0NGR3SS/WAFPierce) | CLI & GUI WAF/CDN fingerprinting and bypass validation tool. Detects 17+ WAFs, 12+ CDNs, runs 35+ bypass techniques with baseline heuristics | Python |
| [GhostState](https://github.com/K0NGR3SS/GhostState) | TUI-based AWS security & governance tool that detects ghost resources (unused/shadow IT) and risk assets in real-time | Go · AWS SDK v2 |
| [GhostWeights](https://github.com/K0NGR3SS/GhostWeights) | Hunts for unauthorised Shadow AI/ML workloads running in AWS environments | Go · AWS SDK v2 |
| [Log_Analyzer](https://github.com/K0NGR3SS/Log_Analyzer) | Reads security logs to detect brute-force attempts, SQLmap scans, and attack patterns — outputs statistical reports and charts | Python |
| [TCP_Recon_Tool](https://github.com/K0NGR3SS/TCP_Recon_Tool) | CLI recon tool: service enumeration, TLS inspection, web stack fingerprinting, machine-readable reports | Python |
| [Image-Detector-AWS](https://github.com/K0NGR3SS/Image-Detector-AWS) | Serverless image analysis system using AWS AI services (Lambda, S3, Rekognition, DynamoDB) | AWS |
